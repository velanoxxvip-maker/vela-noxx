...
NOTA :Si todo eso se te hace complicado aqui te dejo mi segundo usuario 👉 @velanoxx ✅ ✨💖
Ahí podrás mandarme directamente tu comprobante y asegurarte tu acceso 😏💦
"""
MENSAJE_PROMOS = """🔞✨ PROMO DE FIN DE AÑO — SOLO 28, 29 y 30 DE DICIEMBRE 🔞
🔥 Suscripción MENSUAL a mi canal VIP por solo Bs. 100 🔥
Con tu acceso mensual disfrutas:
💋 Lencería premium
📸 Fotos exclusivas
🎥 Videos masturbandome 
 📽️Videos xxx
💎 Contenido profesional y confidencial
🚫 Material original — nada de reposts
👇 Formas de pago & activación 👇
📌 Para la promo mensual de Bs. 100 encontrarás aquí mismo el QR listo para pagar.
💕 IMPORTANTE:
Para activarte envíame:
✔️ Tu comprobante de pago
✔️ Tu nombre de usuario
📩 Si necesitas pagar los paquetes de suscripción:
🔹 2 meses → Bs. 190
🔹 3 meses → Bs. 280
Para esos planes, escríbeme directo a mi usuario personal y te paso el QR correspondiente: @velanoxx ✨
"""
