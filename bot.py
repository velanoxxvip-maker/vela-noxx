...
MENSAJE_PROMOS = """✨ PROMO PREMIUM TRIPLE X – Solo 10, 11 y 12 de diciembre ✨

🔥 Suscripción a SOLO Bs. 100/mes
...
✅ ¿Cómo activar tu PROMO?

Para activarte la promo, necesitas enviarme:
1️⃣ Tu usuario de telegram 
2️⃣ Tu comprobante de pago

Con eso verifico y te envío el link de acceso. 

Si no puedes enviarlo por aquí, también puedes mandarlo directamente a mi usuario:
👉 @velanoxx✅
💣 Pagas 100 y disfrutas TODO un mes de contenido PREMIUM.
💋 Oferta especial de mi mes. Solo 3 días
"""
