...
(Ejemplo: @pedro2025).
NOTA :Si todo esto se te complica, dentro del canal te dejo un segundo usuario 👤💎
Ahí puedes enviarme directamente tu comprobante, y yo lo verifico al instante 😘🔥💬
"""

MENSAJE_PROMOS = """Hola mi amor, ¿cómo estás? 😘💕
Estás en las Promociones Activas de mi Canal VIP Diamante  💎🔥✨
💎 *Donde la suscripcion te sale a tan solo – Bs. 100 / mes* 💎

Aquí vas a encontrar contenido súper explícito 😈💦, colaboracion xxx🔥🤝, videos sin censura 🎥y fotos premium en alta resolución 📸✨
Todo exclusivo para mis VIP 😏💋

Aquí te dejo toda la info + el QR 📲💵💎
Para activar tu acceso necesito que me envíes:
