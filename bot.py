...
✨🌹 Hola mi amor, soy Vela Noxx 🌹✨

Bienvenid@ a mi espacio exclusivo 🔥
Donde podrás obtener toda la información que necesites 💌

😈 Te comento que vendo contenido explícito PREMIUM y actualmente administro 2 grupos exclusivos 💎🔥

👇 Aquí abajo encontrarás los botones con toda la información de cada uno para que elijas el que más te guste y te animes a entrar 😏✨

💋 Descubre todo el contenido que tengo preparado para ti…
Te aseguro que no te vas a arrepentir ❤️‍🔥
"""
MENSAJE_VIP = """
*✨🔥 PROMO FIN DE MES ACTIVA – Solo 30 y 31 de MAYO* 🔥✨
...
"""
MENSAJE_PROMOS = """
✨🔥 Amor, si llegaste hasta aquí es porque quieres algo mucho más exclusivo que el VIP Diamante 🔥✨

Aquí encontrarás TODO lo del canal Diamante… pero con un plus mucho más PREMIUM 😈👇
💋 Suscripción a SOLO Bs. 200  
📅 Acceso válido por 1 mes completo👇 ¿Qué incluye? 👇
💎 Contenido mostrando el rostro💎
👙 Lencería PREMIUM (mostrando el rostro)
🍑 Desnudos completos(mostrando el rostro)
💦 Videos XXX sin censura(mostrando el rostro)
🔥 Videos masturbandome (mostrando el rostro)
 🍑 TODO EL CONTENIDO MOSTRANDO EL ROSTRO 
🔥MATERIAL NUEVO CONSTANTEMENTE🔥
🚨 PARA ACTIVAR LA PROMO🚨
📩 Envíame tu comprobante de pago + tu usuario
👉👉👉 @velanoxx ✅
💎 Pagas Bs.200 y disfrutas TODO un mes completo de contenido PREMIUM
━━━━━━━━━━━━━━━
💎✨ MÉTODOS DE PAGO ✨💎
🇧🇴 Bolivia – 200 Bs
📲 Te envío el QR automáticamente dentro de este mensaje envia tu comprobante a 👉 @velanoxx✅
🇵🇪 Perú – 80 soles
💜 Pago por Yape  📩 Pide el Yape a 👉 @velanoxx✅
🇧🇷  Brasil - 140 Reales (PIX) ✉️ Solicita tu QR o Clave PIX directamente a 👉🏻👉🏻 @velanoxx ✅
🌎 Internacional – 27 USD 💵 Solicita tu metodo de pago
 a 👉👉 @velanoxx✅
🌐 Pagos cripto - 27 USDC o USDT 
🪙  Metodo Binance,Poligon y BNB pide el QR 
a 👉👉 @velanoxx✅
🇪🇺 Euros - 25 EUR solicita el método directamente a 👉🏻 @velanoxx✅
🔥 Acceso por 30 días. 🔥
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    keyboard = [
        [InlineKeyboardButton("🎁PROMO💎zona vip diamante 💎 🎁", callback_data="vip")],
        [InlineKeyboardButton("🎁PROMO👑zona vip ultra premium👑", callback_data="promos")],
